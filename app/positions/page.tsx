    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
        ...
        {mode === 'demo' && totalClaimable > 0n && (
          <div style={{ padding: '10px 20px', background: 'rgba(34,211,238,0.08)', border: '1px solid rgba(34,211,238,0.22)', borderRadius: '12px' }}>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '11px', color: '#4a3d70', marginBottom: '2px' }}>Total Claimable</div>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '20px', fontWeight: 700, color: '#22d3ee' }}>
      ...
      {needsWallet && (
        <div style={{ textAlign: 'center', padding: '80px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-heading)', color: '#ede9ff', margin: 0 }}>Connect your wallet</h2>
          <p style={{ fontFamily: 'var(--font-body)', color: '#9985c8' }}>Connect your wallet to see your on-chain positions.</p>
        </div>
      )}
        ...
        <>
          {demoPositions.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '80px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ fontFamily: 'var(--font-heading)', fontSize: '20px', color: '#4a3d70' }}>No kills yet</div>
              <Link href="/markets"><GlowButton>Browse Hunt Board →</GlowButton></Link>
            </div>
          ) : (
